...
const About = () => {
  const values = [
    ...
    },
    {
      icon: Users,
      title: 'Valores',
      description: 'Transparência, excelência técnica e atendimento personalizado são os pilares da nossa empresa.'
    },
    {
      icon: Lightbulb,
      title: 'Visão',
      description: 'Ser referência em soluções tecnológicas personalizadas para empresas de todos os portes.'
    },
    {
      icon: Award,
      title: 'Experiência',
      description: 'Mais de uma década desenvolvendo soluções que fazem a diferença no mercado brasileiro.'
    }
  ];
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-white/80 max-w-3xl mx-auto">
            Construindo o futuro digital através de soluções tecnológicas inovadoras e suporte especializado
          </p>
        </motion.div>
        ...
        >
          <h3 className="text-3xl font-bold text-center text-white mb-12">Nossa Jornada</h3>
