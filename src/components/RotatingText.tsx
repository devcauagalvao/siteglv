...
const RotatingText = forwardRef<RotatingTextRef, RotatingTextProps>(
  (
    ...
    const splitIntoCharacters = (text: string): string[] => {
      ...
      if (hasSegmenter) {
        // Some TS configs don't include lib definitions for Intl.Segmenter.
    ...
    return (
      <motion.span
        ...
        {...rest}
        layout="size"
        transition={resolvedLayoutTransition}
      >
        <span className="sr-only">{texts[currentTextIndex]}</span>
        <AnimatePresence mode={animatePresenceMode} initial={animatePresenceInitial} presenceAffectsLayout>
          <motion.span
