                ...
                <motion.div className="space-y-5" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.1 }}>
                  ...
                  <div>
                    ...
                    <GlassTextarea
                      ...
                      maxLength={500}
                      className="resize-none h-28"
                      hasError={!!errors.currentSituation}
                      required
                    />
                    <div className="flex items-center justify-between mt-2">
                  ...
                  <div>
                    ...
                    <div className="space-y-2.5 max-h-48 overflow-y-auto pr-2">
                      {[
                        ...
                        <GlassChoiceButton
                          key={feature}
                          selected={formData.requiredFeatures.includes(feature)}
                    ...
                    <div className="space-y-2.5">
                      {[
                        ...
                        <GlassChoiceButton
                          ...
                          selected={formData.supportNeeded.includes(support)}
